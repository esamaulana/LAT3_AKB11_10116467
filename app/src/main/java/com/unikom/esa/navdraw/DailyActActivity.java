...
public class DailyActActivity extends AppCompatActivity {
    ...
    void addData() {
        ...
        mahasiswaArrayList.add(new DailyActActivity_2("Siap - siap olah raga", "5.00 - 6.00", "Kadang"));
        mahasiswaArrayList.add(new DailyActActivity_2("Olah Raga", "6.00 - 8.00", "Kadang"));
        mahasiswaArrayList.add(new DailyActActivity_2("Sarapan", "8.00 - 8.15", "Rutin"));
        mahasiswaArrayList.add(new DailyActActivity_2("Ngegame", "8.30 - 10.00", "Kadang"));
        mahasiswaArrayList.add(new DailyActActivity_2("Latihan Latihan", "10.00 - 11.45", "Kadang"));
        mahasiswaArrayList.add(new DailyActActivity_2("Istirahat Sholat", "11.45 - 12.15", "Rutin"));
        mahasiswaArrayList.add(new DailyActActivity_2("Latihan Latihan", "12.30 - 15.00", "Kadang"));
        ...
        mahasiswaArrayList.add(new DailyActActivity_2("Latihan Latihan", "20.00 - 24.00", "kadang"));
